...
public class MemedKillMessage extends KillMessage {
    public MemedKillMessage() {
        super("Memed", "memed_killmessage", "Meme on dem Noobs",
                Material.GOLD_NUGGET, "%killed% was memed by %killer%", "%killed% was yeeted by %killer%", "%killed% was bruh momented by %killer%"
        );
    }
}
